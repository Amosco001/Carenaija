      ...
      <div className="border-b bg-muted/30">
        <div className="container mx-auto px-4 py-4">
          <nav className="flex items-center gap-2 text-sm text-muted-foreground" data-testid="breadcrumb-privacy">
            <Link href="/" className="hover:text-foreground" data-testid="link-privacy-home">Home</Link>
            <ChevronRight className="h-4 w-4" />
            <Link href="/help" className="hover:text-foreground" data-testid="link-privacy-help">Help Center</Link>
            <ChevronRight className="h-4 w-4" />
            <span className="text-foreground" data-testid="text-privacy-current">Privacy Policy</span>
          </nav>
        </div>
      </div>
